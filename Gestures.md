...
# Gestures — Trackpad Gesture Customizer for macOS

Gestures is a lightweight and powerful application for macOS that lets you control your computer using custom trackpad gestures. By sliding or clicking with three, four, or five fingers, you can manage windows, control media, launch apps, take screenshots, and trigger system shortcuts. 

Gestures works in the background and intercepts your trackpad movements, translating them into actions instantly.
...
Instead of memorizing complex keyboard shortcuts, Gestures lets you use natural trackpad movements. Every gesture you configure is built on a few simple elements:

*   **Finger Count:** Gestures supports gestures using **3**, **4**, or **5** fingers.
*   **Gesture Types:** 
...
*   **Swipe Speed:** You can map different actions to the exact same swipe depending on how fast you move. Gestures recognizes **Slow**, **Normal**, and **Fast** swipes. For example, a slow three-finger swipe right can switch to the next open window, while a fast flick right can launch your browser.

---

## 2. Smart Filters & Conditions

You don't have to use the same gestures for everything. Gestures lets you restrict your gestures using rules so they only trigger under specific conditions:
...
*   **Open App...:** Launches an application of your choice. When setting up this gesture, Gestures opens a file picker so you can select any app in your Applications folder.
...
Gestures includes custom calibration options so you can fine-tune how sensitive your trackpad is to gestures:

### Recognition (How swipes are detected)
*   **Activation Threshold:** Adjusts how far your fingers must travel on the trackpad before Gestures registers it as a swipe. Increase this if you find yourself triggering swipes accidentally, or decrease it for faster response times.
...
*   **Slow Velocity Threshold:** The speed limit below which a swipe is classified as a "Slow" Gestures.
*   **Speed Sample Frames:** The number of tiny frame segments Gestures averages together to calculate the speed of your movement. Increasing this smooths out shaky finger movements.
...
*   **Candidate Frames:** The number of frames Gestures analyzes at the very beginning of a touch before deciding if it's a swipe. Higher values help separate swipes from standard pinch-to-zoom gestures.
*   **Pinch Spread Threshold:** The overall limit on how much your fingers can spread apart or come together during a gesture. If this limit is exceeded, Gestures assumes you are pinching/zooming and cancels the swipe.
...
Gestures's general settings menu lets you configure how the app behaves globally:

*   **Accessibility Assistant:** A simple card showing whether Gestures has the macOS security permissions it needs. If permissions are missing, a button is provided to open your Mac's System Settings directly to the correct page.
...
*   **Launch at Login:** Automatically opens Gestures every time you boot up your Mac.
...
`~/Library/Application Support/Gestures/config.yaml`
These settings will keep being updated in the file as they are changes from the gui. And they can also be edited in the file and they will be reflected in the gui. 

Gestures provides several tools in the **Configuration** tab to manage this file:
*   **Open folder button:** Instantly opens the folder containing your config file in Finder.
*   **Export Copy...:** Saves a backup copy of your configuration file anywhere on your Mac. You can use this to keep backups or share your custom layout with other Gestures users.
